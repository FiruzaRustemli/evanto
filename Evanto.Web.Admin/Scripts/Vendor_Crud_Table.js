        ...
        $("#Vendor_crud")
            .jtable({
                ...
                deleteConfirmation: function (t) {
                    t.deleteConfirmMessage = "Are you sure to delete Vendor : " + t.record.Name + "?";
                },
                ...
                actions: {
                    listAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'Vendor/Vendorlist?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                        ...
                        return $.Deferred(function ($dfd) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Vendor Updated succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                                    showNotification(message, status, pos);
                        ...
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                ...
                                success: function (data) {
                                    $dfd.resolve(data);
                                    var message =
                                        "<a href='#' class='notify-action'>Clear</a> Vendor Deleted succesfuly";
                                    var status = "success";
                                    var pos = "top-right";
                                    showNotification(message, status, pos);
