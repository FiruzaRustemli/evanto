        ...
        $("#UserStatus_crud")
            .jtable({
                ...
                deleteConfirmation: function (t) {
                    t.deleteConfirmMessage = "Are you sure to delete User Status : " + t.record.Name + "?"
                },
                ...
                actions: {
                    listAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'UserStatus/UserStatusList?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                    ...
                    createAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'UserStatus/CreateUserStatus',
                                type: 'post',
                                dataType: 'json',
                                data: postData,
                                success: function (data) {
                                    ...
                                    if (data.Result === "OK") {
                                        var message =
                                            "<a href='#' class='notify-action'>Clear</a> UserStatus added succesfuly";
                                        var status = "success";
                                        var pos = "top-right";
                        ...
                        return $.Deferred(function ($dfd) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.Result === "OK") {
                                        var message =
                                            "<a href='#' class='notify-action'>Clear</a> UserStatus Updated succesfuly";
                                        var status = "success";
                                        var pos = "top-right";
                                        showNotification(message, status, pos);
                                    }
                    ...
                    //    return $.Deferred(function ($dfd) {
                    //        $.ajax({
                    //            url: 'UserStatus/DeleteUserStatus',
                    //            type: 'post',
                    //            dataType: 'json',
                    //            data: postData,
                    //            success: function (data) {
                    //                $dfd.resolve(data);
                    //                var message =
                    //                    "<a href='#' class='notify-action'>Clear</a>" + data.Record;
                    //                var status = "success";
                    //                var pos = "top-right";
                    //                showNotification(message, status, pos);
