        ...
        $("#Service_crud")
            .jtable({
                ...
                deleteConfirmation: function (t) {
                    t.deleteConfirmMessage = "Are you sure to delete Service : " + t.record.Name + "?"
                },
                ...
                actions: {
                    listAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'Service/ServiceList?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                        ...
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.Result === "OK") {
                                        var message =
                                            "<a href='#' class='notify-action'>Clear</a> Service added succesfuly";
                                        var status = "success";
                                        var pos = "top-right";
