        ...
        $("#ServicePeriod_crud")
            .jtable({
                ...
                deleteConfirmation: function (t) {
                    t.deleteConfirmMessage = "Are you sure to delete ServicePeriod : " + t.record.Name + "?"
                },
                ...
                actions: {
                    listAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'ServicePeriod/ServicePeriodList?jtStartIndex=' + jtParams.jtStartIndex + '&jtPageSize=' + jtParams.jtPageSize,
                                type: 'get',
                                dataType: 'json',
                                data: postData,
                    ...
                    createAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            $.ajax({
                                url: 'ServicePeriod/CreateServicePeriod',
                                type: 'post',
                                dataType: 'json',
                                data: postData,
                                success: function (data) {
                                    ...
                                    if (data.Result === "OK") {
                                        var message =
                                            "<a href='#' class='notify-action'>Clear</a> ServicePeriod added succesfuly";
                                        var status = "success";
                                        var pos = "top-right";
                    ...
                    updateAction: function (postData, jtParams) {
                        return $.Deferred(function ($dfd) {
                            ...
                            $.ajax({
                                url: 'ServicePeriod/UpdateServicePeriod',
                                type: 'post',
                                dataType: 'json',
                                data: postData,
                                success: function (data) {
                    ...
                    //    return $.Deferred(function ($dfd) {
                    //        $.ajax({
                    //            url: 'ServicePeriod/DeleteServicePeriod',
                    //            type: 'post',
                    //            dataType: 'json',
                    //            data: postData,
                    //            success: function (data) {
                    //                $dfd.resolve(data);
                    //                var message =
                    //                    "<a href='#' class='notify-action'>Clear</a> ServicePeriod Deleted succesfuly";
                    //                var status = "success";
                    //                var pos = "top-right";
                    //                showNotification(message, status, pos);
