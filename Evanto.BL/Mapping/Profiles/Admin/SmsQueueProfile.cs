...
{
    public class SmsQueueProfile : Profile
    {
        public SmsQueueProfile()
        {
            CreateMap<SmsQueue, SmsQueueAdminDto>();
            CreateMap<SmsStatus, SmsStatusAdminDto>();
            CreateMap<SmsType, SmsTypeAdminDto>();
        }
    }
}
