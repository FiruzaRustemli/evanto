(function ()
{
    ...
    /** @ngInject */
    function MsNavigationController($scope, msNavigationService, navbarHelper)
    {
        var vm = this;
    ...
    /** @ngInject */
    function MsNavigationNodeController($scope, $element, $rootScope, $animate, $state, msNavigationService, navbarHelper)
    {
        var vm = this;
